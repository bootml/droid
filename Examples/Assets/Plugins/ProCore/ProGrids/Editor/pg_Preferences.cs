...
namespace ProGrids {
  public class pg_Preferences {
    ...
    static readonly string[] SnapMethod = {"Snap on Selected Axis", "Snap on All Axes"};

    static readonly int[] SnapVals = {1, 0};
    ...
    public static void PreferencesGUI() {
      ...
      _alphaBump = EditorGUILayout.Slider(
          new GUIContent(
              "Tenth Line Alpha",
              "Every 10th line will have it's alpha value bumped by this amount."),
          _alphaBump,
          0f,
          1f);
    ...
    public static bool LoadPreferences() {
      _scaleSnapEnabled = EditorPrefs.HasKey("scaleSnapEnabled")
                              ? EditorPrefs.GetBool("scaleSnapEnabled")
                              : false;
