...
namespace ProGrids {
  public class pg_GridRenderer {
    ...
    static int tan_iter, bit_iter, max = MAX_LINES, div = 1;
    ...
    public static void Init() {
      ...
      gridObject = EditorUtility.CreateGameObjectWithHideFlags(
          PREVIEW_OBJECT_NAME,
          PG_HIDE_FLAGS,
          typeof(MeshFilter),
          typeof(MeshRenderer));
    ...
    static void DestoryObjectsWithName(string Name, Type type) {
    ...
    public static void DrawGridPerspective(
        Camera cam,
        Vector3 pivot,
        float snapValue,
        Color[] colors,
    ...
    static void DrawFullGrid(
      ...
      var highlightOffsetBitan =
          (int)(pg_Util.ValueFromMask(start, bitan) % (inc * majorLineIncrement) / inc);
     ...
     */
    static float[] GetDistanceToFrustumPlanes(
        Camera cam,
        Vector3 pivot,
        Vector3 tan,
        Vector3 bitan,
