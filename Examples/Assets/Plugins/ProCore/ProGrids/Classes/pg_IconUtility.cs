...
namespace ProGrids {
  ...
  public static class pg_IconUtility {
    ...
    static readonly string iconFolderPath = "Assets/ProCore/ProGrids/GUI/ProGridsToggles/";
    ...
    static string FindFolder(string folder) {
      #if !UNITY_WEBPLAYER
    ...
    public static Texture2D LoadIcon(string iconName) {
      ...
      if (!File.Exists(iconPath)) {
        Debug.LogError(
            "ProGrids failed to locate menu image: "
            + iconName
